...
struct PlayHistoryView: View {
    ...
    var content: some View {
        ...
        .overlay(NavigationBar(title: "Play History", contentHasScrolled: $contentHasScrolled).offset(x: 20))
    }
    
    var sectionsSection: some View {
        VStack(spacing: 16) {
            ForEach(Array(playList.enumerated()), id: \.offset) { index, section in
