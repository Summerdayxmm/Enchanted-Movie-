    ...
    var body: some View {
        ...
        .background(
            ZStack {
                ...
                LinearGradient(colors: [Color(#colorLiteral(red: 0.3647058904, green: 0.06666667014, blue: 0.9686274529, alpha: 1)).opacity(0.2), Color(#colorLiteral(red: 0.5568627715, green: 0.3529411852, blue: 0.9686274529, alpha: 1)).opacity(0.2)], startPoint: .topLeading, endPoint: .bottomTrailing)
                    .opacity(show ? 1 : 0)
                    .blendMode(.overlay)
...
////                    .opacity(0.9)
//                            Text("LlalaLand")
////                                .font(Font.custom("England Hand DB", size: 50))
//                                .font(.title).bold()
