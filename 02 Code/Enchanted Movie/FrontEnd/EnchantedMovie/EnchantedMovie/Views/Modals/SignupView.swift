...
//    @State var password = ""
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 20) {
            ...
            Text("Access over 10000 movies and explore the world of movies with like-minded friends")
                .font(.headline)
...
//                .keyboardType(.emailAddress)
            ...
            Button {
                RegisterService.register(username: username, password: password) { success in
                                    if success {
                                        registerState = true
//                                        isLogged = true
//                                        dismissModal()
            ...
            .alert(isPresented: $registerState) {
                Alert(title: Text("Message Reminder"), message: Text("Register Success"), dismissButton: .default(Text("Confirm")))
            }
